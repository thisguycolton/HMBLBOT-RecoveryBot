 ...
 */
export function DefineableMixin<T extends import("../../types.js").Constructor<HTMLElement>>(superclass: T): {
    new (...args: any[]): {
        accessKey: string;
...
declare const DefineableElement_base: {
    new (...args: any[]): {
        accessKey: string;
        readonly accessKeyLabel: string;
        autocapitalize: string;
 ...
 *   MyCard.define()
 */
export class DefineableElement extends DefineableElement_base {
}
export {};
