 ...
 * @param {T} superclass
 */
export function ScopedElementsMixin<T extends import("../../types.js").Constructor<HTMLElement>>(superclass: T): {
    new (...args: any[]): {
        /** @type {RenderOptions} */
         ...
         * @returns {void}
         */
        adoptStyles(_shadowRoot: ShadowRoot): void;
        /**
         ...
         */
        defineScopedElement(tagName: string, klass: typeof HTMLElement): void | CustomElementConstructor;
        accessKey: string;
     ...
     */
    readonly scopedElements: ScopedElementsMap;
    /**
